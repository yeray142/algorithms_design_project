...
{
	// Si Punts és Buit retornar la llista [A,B]
	...
	CVertex* c = punts.m_Vertices.front();
	double max = AreaTriangle(a->m_Point, c->m_Point, b->m_Point);
...
CConvexHull QuickHull(CGraph& graph)
{
	...
	// Buscar dos punts extrems A i B que poden ser el que està més a l’esquerra i el que està més a la dreta.
	...
	// TODO: Ajuntar les dues CHUp i CHDown concatenant les llistes de punts. Compta en no repetir els punts A i B que pertanyen a les dues parts.
